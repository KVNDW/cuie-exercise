...
//import { projectLoggingChoice, LOGGING_CHOICE_CSS } from "./loggingLevelProjector.js"; // original
//import { projectLoggingChoice, LOGGING_CHOICE_CSS } from "../../../cuie/loggingLevelProjector.js"; // example
import { projectLoggingChoice, LOGGING_CHOICE_CSS } from "../../../cuie/project/loggingLevelProjector.js"; // our Code
/*                                                        ^^^^^^^^^^^^^^^^^^^^^^^^^^^
